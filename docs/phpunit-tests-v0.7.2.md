# DateBook SafeDate Tracker v0.7.2 PHPUnit Test Release

v0.7.2 adds automated PHPUnit coverage for the highest-risk areas identified in the v0.7 QA pass and v0.7.1 stabilization release.
