# DateBook SafeDate Tracker v0.7.6 PHPUnit Test Release

v0.7.6 adds automated PHPUnit coverage for the highest-risk areas identified in the v0.7 QA pass and v0.7.3 stabilization release.
...
- Behavioral tests for pairing ID requirement.
- Behavioral tests for pairing-code attempt lockout.
- Behavioral tests for single-use atomic claim behavior.
- Native starter samples updated to call the pairing endpoint before signed location submission.

## v0.7.8 additions

- NativeSignatureCompatibilityTest validates canonical route HMAC vectors.
- PairingTelemetryTest validates pairing-attempt persistence for successful native pairing.
